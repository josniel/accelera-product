...
export default function InputFieldFixture() {
  ...
  const usdxRedeemableInFront = dn.format(getDebtBeforeIndex(valueIndex), { compact: true });

  const usdxInterestPerYear = parsedValue
          ...
          start: (
            ...
            >
              ...
              >
                ...
                >
                  {usdxRedeemableInFront}
                </span>
                <span>{" USDX to redeem"}</span>
              </span>
            </span>
          ),
        }}
