...
const DEFAULT_COMMIT_URL = "https://github.com/liquity/usdx/tree/{commit}";
const DEFAULT_VERSION_URL = "https://github.com/liquity/usdx/releases/tag/%40liquity2%2Fapp-v{version}";

const DEFAULT_LEGACY_CHECKS = new Map<number, LegacyCheck>([
  // mainnet
  [1, {
    USDX_TOKEN: "0xb01dd87b29d187f3e3a4bf6cdaebfb97f3d9ab98",
  ...
  // sepolia
  [11155111, {
    USDX_TOKEN: "0xb01d32c05f4aa066eef2bfd4d461833fddd56d0a",
...
export const EnvSchema = v.pipe(
  v.object({
    ...
    CONTRACT_ACCEL_STAKING: vAddress(),
    CONTRACT_ACCEL_TOKEN: vAddress(),
...
const parsedEnv = v.safeParse(EnvSchema, {
  ...
  CONTRACT_USDX_TOKEN: process.env.NEXT_PUBLIC_CONTRACT_USDX_TOKEN,
  ...
  CONTRACT_ACCEL_STAKING: process.env.NEXT_PUBLIC_CONTRACT_ACCEL_STAKING,
  CONTRACT_ACCEL_TOKEN: process.env.NEXT_PUBLIC_CONTRACT_ACCEL_TOKEN,
...
export const {
  ...
  CONTRACT_ACCEL_STAKING,
  CONTRACT_ACCEL_TOKEN,
  CONTRACT_LUSD_TOKEN,
