...
export function PanelInterestRate({
  ...
  const debt = useInputFieldValue((value) => `${fmtnum(value, "full")} USDX`, {
  ...
  const usdxInterestPerYear = interestRate
    && debt.parsed
    && dn.mul(debt.parsed, interestRate);

  const usdxInterestPerYearPrev = loan.interestRate
    && loan.borrowed
        ...
        <UpdateBox
          updates={[
            ...
            },
            {
              label: (
                <>
                  <div>USDX interest per year</div>
                  <InfoTooltip {...infoTooltipProps(content.generalInfotooltips.interestRateUsdxPerYear)} />
                </>
              ),
              before: <Amount value={usdxInterestPerYearPrev} suffix=" USDX" />,
              after: <Amount value={usdxInterestPerYear} suffix=" USDX" />,
            },
          ]}
        />
      </div>
