...
export const openLeveragePosition: FlowDeclaration<OpenLeveragePositionRequest> = {
  ...
  Details({ request }) {
    ...
    const yearlyUsdxInterest = dn.mul(loan.borrowed, loan.interestRate);
          ...
          ? (
            <TransactionDetailsRow
              ...
              value={[
                ...
                <div key="end">
                  {fmtnum(loan.interestRate, "pctfull")}% ({fmtnum(yearlyUsdxInterest, {
                    digits: 4,
                    dust: false,
                    prefix: "~",
                  })} USDX per year)
          ...
          : (
            <TransactionDetailsRow
              ...
              value={[
                ...
                `${fmtnum(dn.mul(loan.borrowed, loan.interestRate))} USDX per year`,
              ]}
            />
          )}
        <TransactionDetailsRow
    ...
    openLeveragedTrove: {
      ...
      async commit(ctx) {
        ...
        const txParams = {
          ...
          usdxAmount: openLeveragedParams.effectiveUsdxAmount,
          upperHint,
          lowerHint,
