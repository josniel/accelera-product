...
export const openBorrowPosition: FlowDeclaration<OpenBorrowPositionRequest> = {
  ...
  Summary({ request }) {
    ...
    const usdxAmountWithFee = upfrontFee.data && dn.add(
      request.usdxAmount,
      upfrontFee.data,
    );
    ...
    return (
      <LoanCard
        ...
        loan={{
          ...
          borrowed: usdxAmountWithFee ?? dnum18(0),
  ...
  Details({ request }) {
    ...
    const { branchId, interestRateDelegate, usdxAmount } = request;
    const delegate = useInterestBatchDelegate(branchId, interestRateDelegate);
    const yearlyUsdxInterest = dn.mul(
      usdxAmount,
          ...
          value={[
            ...
            >
              <Amount
                ...
                suffix=" USDX creation fee"
              />
              <InfoTooltip heading="USDX Creation Fee">
                    ...
                    : (
                      <>
                        ...
                        <Amount
                          format="2z"
                          prefix="~"
                          suffix=" USDX per year"
                          value={yearlyUsdxInterest}
                        />
                      </>
                    )}
                </div>,
            ...
            <TransactionDetailsRow
              ...
              value={[
                ...
                <Amount
                  key="end"
                  fallback="…"
                  value={usdxAmountWithFee && dn.mul(
                    usdxAmountWithFee,
      ...
      async commit(ctx) {
        ...
        return ctx.writeContract({
          ...
          args: [{
            ...
            usdxAmount: ctx.request.usdxAmount[0],
            upperHint,
            lowerHint,
