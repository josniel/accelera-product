...
// export function useContinuousUsdxGains(
...
//       { ...SP, functionName: "getTotalUsdxDeposits" },
...
//   if (pendingSPYield > 0n && snapshotsEpoch === currentEpoch && totalUsdxDeposits >= DECIMAL_PRECISION) {
//     const yieldNumerator = pendingSPYield * DECIMAL_PRECISION + lastYieldError;
//     const yieldPerUnitStaked = yieldNumerator / totalUsdxDeposits;
