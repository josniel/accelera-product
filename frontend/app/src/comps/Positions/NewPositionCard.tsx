...
const actions = {
  borrow: {
    colors: {
      ...
      foreground: token("colors.content"),
      foregroundAlt: token("colors.contentAlt2"),
    },
    ...
    >
      ...
      >
        {actionsEntries.map(([type, {
          ...
          console.log("type as keyof typeof actions :>> ", type as keyof typeof actions);
          ...
          const style = {
            ...
            background: "linear-gradient(16deg, #0D110E 11.36%, #374A39 88.82%)",
