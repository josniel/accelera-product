...
export const InterestRateField = memo(
  function InterestRateField({
    ...
    const usdxInterestPerYear = interestRate && debt && dn.mul(interestRate, debt);
          ...
          secondary={{
            start: (
              ...
              >
                ...
                >
                  {usdxInterestPerYear && (mode === "manual" || delegate !== null)
                    ? fmtnum(usdxInterestPerYear, breakpoint === "sm" ? "compact" : "2z")
                    : "−"} USDX / year
                </div>
                <InfoTooltip {...infoTooltipProps(content.generalInfotooltips.interestRateUsdxPerYear)} />
              </div>
            ),
              ...
              show && (
                ...
                >
                  <span>
                    {breakpoint === "lg" ? "Redeemable before you: " : "Red. before: "}
                    <span
                      className={css({
          ...
          valueUnfocused={
            ...
            (mode !== "manual" && delegate === null)
              ...
              ? (
                ...
                >
                  {delegate !== null && breakpoint === "lg" && <MiniChart size="medium" />}
                  <span
                    style={{
                      fontVariantNumeric: "tabular-nums",
                    }}
