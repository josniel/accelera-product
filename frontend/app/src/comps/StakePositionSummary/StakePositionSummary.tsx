              ...
              {appear((style, show) => (
                show && (
                  ...
                  >
                    ...
                    <TokenIcon symbol="ACCEL" size={32} />
                  </a.div>
                )
              ))}
              {prevStakePosition
                ...
                && (
                  <div
                    title={`${fmtnum(prevStakePosition.deposit, "full")} ACCEL`}
                    className={css({
                      color: "contentAlt",
        ...
        >
                        ...
                        content={{
                          ...
                          body: (
                            ...
                            >
                              ...
                              {account.address && (govUser.data?.allocatedACCEL ?? 0n) > 0n && (
                                <div
                                  className={css({
                                    display: "flex",
                                    flexDirection: "column",
                          ...
                          footerLink: {
                            href: "https://docs.liquity.org/v2-faq/accel-staking",
                            label: "Learn more",
                          },
                        }}
                      />
          ...
          {!txPreviewMode && (
            ...
            >
              ...
              <div
                title={`${fmtnum([govUser.data?.allocatedACCEL ?? 0n, 18], "full")} ACCEL`}
                className={css({
                  display: "flex",
                  alignItems: "center",
                  gap: 4,
              ...
              >
                <Amount
                  title={null}
                  format="compact"
                  value={[govUser.data?.allocatedACCEL ?? 0n, 18]}
                />
                <TokenIcon
                  title={null}
                  symbol="ACCEL"
