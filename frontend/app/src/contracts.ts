...
import { AccelStaking } from "@/src/abi/AccelStaking";
import { AccelToken } from "@/src/abi/AccelToken";
...
export const CONTRACTS: Contracts = {
  UsdxToken: { abi: abis.UsdxToken, address: CONTRACT_USDX_TOKEN },
  CollateralRegistry: {
  ...
  AccelStaking: { abi: abis.AccelStaking, address: CONTRACT_ACCEL_STAKING },
  AccelToken: { abi: abis.AccelToken, address: CONTRACT_ACCEL_TOKEN },
