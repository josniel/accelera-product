...
export type GovernanceAllocation = {
  ...
  user: GovernanceUser;
  vetoACCEL: Scalars["BigInt"]["output"];
  voteACCEL: Scalars["BigInt"]["output"];
};
...
export type GovernanceAllocation_Filter = {
  ...
  vetoACCEL?: InputMaybe<Scalars["BigInt"]["input"]>;
  vetoACCEL_gt?: InputMaybe<Scalars["BigInt"]["input"]>;
  vetoACCEL_gte?: InputMaybe<Scalars["BigInt"]["input"]>;
  vetoACCEL_in?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
  vetoACCEL_lt?: InputMaybe<Scalars["BigInt"]["input"]>;
  vetoACCEL_lte?: InputMaybe<Scalars["BigInt"]["input"]>;
  vetoACCEL_not?: InputMaybe<Scalars["BigInt"]["input"]>;
  vetoACCEL_not_in?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
  voteACCEL?: InputMaybe<Scalars["BigInt"]["input"]>;
  voteACCEL_gt?: InputMaybe<Scalars["BigInt"]["input"]>;
  voteACCEL_gte?: InputMaybe<Scalars["BigInt"]["input"]>;
  voteACCEL_in?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
  voteACCEL_lt?: InputMaybe<Scalars["BigInt"]["input"]>;
  voteACCEL_lte?: InputMaybe<Scalars["BigInt"]["input"]>;
  voteACCEL_not?: InputMaybe<Scalars["BigInt"]["input"]>;
  voteACCEL_not_in?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
};
...
export enum GovernanceAllocation_OrderBy {
  ...
  User = "user",
  UserAllocatedAccel = "user__allocatedACCEL",
  UserId = "user__id",
  UserStakedAccel = "user__stakedACCEL",
...
export type GovernanceUser = {
  ...
  allocatedACCEL: Scalars["BigInt"]["output"];
  allocations: Array<GovernanceAllocation>;
  id: Scalars["ID"]["output"];
  stakedACCEL: Scalars["BigInt"]["output"];
...
export type GovernanceUser_Filter = {
  ...
  allocatedACCEL?: InputMaybe<Scalars["BigInt"]["input"]>;
  allocatedACCEL_gt?: InputMaybe<Scalars["BigInt"]["input"]>;
  allocatedACCEL_gte?: InputMaybe<Scalars["BigInt"]["input"]>;
  allocatedACCEL_in?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
  allocatedACCEL_lt?: InputMaybe<Scalars["BigInt"]["input"]>;
  allocatedACCEL_lte?: InputMaybe<Scalars["BigInt"]["input"]>;
  allocatedACCEL_not?: InputMaybe<Scalars["BigInt"]["input"]>;
  allocatedACCEL_not_in?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
  ...
  stakedACCEL?: InputMaybe<Scalars["BigInt"]["input"]>;
  stakedACCEL_gt?: InputMaybe<Scalars["BigInt"]["input"]>;
  stakedACCEL_gte?: InputMaybe<Scalars["BigInt"]["input"]>;
  stakedACCEL_in?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
  stakedACCEL_lt?: InputMaybe<Scalars["BigInt"]["input"]>;
  stakedACCEL_lte?: InputMaybe<Scalars["BigInt"]["input"]>;
  stakedACCEL_not?: InputMaybe<Scalars["BigInt"]["input"]>;
  stakedACCEL_not_in?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
...
export type BorrowerInfoQuery = {
  __typename?: "Query";
  borrowerInfo?: { __typename?: "BorrowerInfo"; nextOwnerIndexes: Array<number> } | null;
};
...
export type TroveStatusesByAccountQuery = {
  __typename?: "Query";
  troves: Array<
    {
      __typename?: "Trove";
...
export type TroveStatusByIdQuery = {
  __typename?: "Query";
  trove?: {
    __typename?: "Trove";
    id: string;
...
export type InterestBatchesQuery = {
  __typename?: "Query";
  interestBatches: Array<
    {
      __typename?: "InterestBatch";
      batchManager: string;
      debt: bigint;
      ...
      collateral: { __typename?: "Collateral"; collIndex: number };
    }
  >;
};
...
export type AllInterestRateBracketsQuery = {
  __typename?: "Query";
  interestRateBrackets: Array<
    {
      __typename?: "InterestRateBracket";
      rate: bigint;
      totalDebt: bigint;
...
export type GovernanceInitiativesQuery = {
  __typename?: "Query";
  governanceInitiatives: Array<{ __typename?: "GovernanceInitiative"; id: string }>;
};
...
export type GovernanceUserAllocationsQuery = {
  __typename?: "Query";
  governanceUser?: { __typename?: "GovernanceUser"; allocated: Array<string> } | null;
};
