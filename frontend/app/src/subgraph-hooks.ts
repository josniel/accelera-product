...
//       allocatedACCEL: BigInt(governanceUser.allocatedACCEL),
//       stakedACCEL: BigInt(governanceUser.stakedACCEL),
//       stakedOffset: BigInt(governanceUser.stakedOffset),
//       allocations: governanceUser.allocations.map((allocation) => ({
//         ...allocation,
//         voteACCEL: BigInt(allocation.voteACCEL),
//         vetoACCEL: BigInt(allocation.vetoACCEL),
...
//       ...governanceStats,
//       totalACCELStaked: BigInt(governanceStats.totalACCELStaked),
