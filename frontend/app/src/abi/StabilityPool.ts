...
export const StabilityPool = [
  ...
  },
  {
    ...
    "name": "usdxToken",
    "inputs": [],
    "outputs": [{ "name": "", "type": "address", "internalType": "contract IUsdxToken" }],
    "stateMutability": "view",
  },
  ...
  {
    "type": "function",
    "name": "triggerUsdxRewards",
    "inputs": [{ "name": "_usdxYield", "type": "uint256", "internalType": "uint256" }],
    "outputs": [],
    "stateMutability": "nonpayable",
  },
  {
  ...
  {
    "type": "event",
    "name": "StabilityPoolUsdxBalanceUpdated",
