...
contract OraclesMainnet is TestAccounts {
    ...
    function redeem(address _from, uint256 _usdxAmount) public {
        vm.startPrank(_from);
        collateralRegistry.redeemCollateral(_usdxAmount, MAX_UINT256, 1e18);
        vm.stopPrank();
    }
    ...
    function testNormalWETHRedemptionDoesNotHitShutdownBranch() public {
        ...
        uint256 totalUsdxRedeemAmount = 100e18;
        uint256 branch0DebtBefore = contractsArray[0].activePool.getUsdxDebt();
        assertGt(branch0DebtBefore, 0);

        uint256 usdxBalBefore_A = usdxToken.balanceOf(A);

        // Redeem
        redeem(A, totalUsdxRedeemAmount);

        // Confirm A lost no USDX
        assertEq(usdxToken.balanceOf(A), usdxBalBefore_A);

        // Confirm WETH branch did not get redeemed from
        assertEq(contractsArray[0].activePool.getUsdxDebt(), branch0DebtBefore);
    }
    ...
    function testNormalRETHRedemptionDoesNotHitShutdownBranch() public {
        ...
        uint256 totalUsdxRedeemAmount = 100e18;
        uint256 branch1DebtBefore = contractsArray[1].activePool.getUsdxDebt();
        ...
        assertEq(contractsArray[1].activePool.getUsdxDebt(), branch1DebtBefore);
    }
    ...
    function testNormalWSTETHRedemptionDoesNotHitShutdownBranch() public {
        ...
        uint256 totalUsdxRedeemAmount = 100e18;
        uint256 branch2DebtBefore = contractsArray[2].activePool.getUsdxDebt();
        ...
        // Confirm RETH branch did not get redeemed from
        assertEq(contractsArray[2].activePool.getUsdxDebt(), branch2DebtBefore);
    }
    ...
    function testRedemptionOfWETHUsesETHUSDMarketforPrimaryPrice() public {
        ...
        uint256 totalUsdxRedeemAmount = 100e18;
        uint256 totalCorrespondingColl = totalUsdxRedeemAmount * DECIMAL_PRECISION / expectedPrice;
        ...
        assertEq(contractsArray[0].activePool.getUsdxDebt(), branch0DebtBefore - totalUsdxRedeemAmount);
    ...
    function testRedemptionOfWSTETHUsesMaxETHUSDMarketandWSTETHUSDMarketForPrimaryPriceWhenWithin1pct() public {
        ...
        assertEq(contractsArray[2].activePool.getUsdxDebt(), branch2DebtBefore - totalUsdxRedeemAmount);
    ...
    function testRedemptionOfWSTETHUsesMinETHUSDMarketandWSTETHUSDMarketForPrimaryPriceWhenNotWithin1pct() public {
        ...
        // Confirm WSTETH branch got redeemed from
        assertEq(
            contractsArray[2].activePool.getUsdxDebt(),
            branch2DebtBefore - totalUsdxRedeemAmount,
    ...
    function testRedemptionOfRETHUsesMaxCanonicalAndMarketforPrimaryPriceWhenWithin2pct() public {
        ...
        assertEq(contractsArray[1].activePool.getUsdxDebt(), branch1DebtBefore - totalUsdxRedeemAmount);
    ...
    function testRedemptionOfRETHUsesMinCanonicalAndMarketforPrimaryPriceWhenDeviationGreaterThan2pct() public {
        ...
        // Confirm RETH branch got redeemed from
        assertEq(
            contractsArray[1].activePool.getUsdxDebt(),
            branch1DebtBefore - totalUsdxRedeemAmount,
