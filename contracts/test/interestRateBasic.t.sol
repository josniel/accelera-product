...
contract InterestRateBasic is DevTestSetup {
    ...
    function testWithdrawUsdxSetsTroveLastDebtUpdateTimeToNow() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 2000e18;
        uint256 interestRate = 25e16;
        uint256 usdxWithdrawal = 500e18;
        ...
        // A draws more debt
        withdrawUsdx100pct(A, ATroveId, usdxWithdrawal);
        assertEq(troveManager.getTroveLastDebtUpdateTime(ATroveId), block.timestamp);
    }

    function testWithdrawUsdxReducesTroveAccruedInterestTo0() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 2000e18;
        uint256 interestRate = 25e16;
        uint256 usdxWithdrawal = 500e18;
    ...
    function testWithdrawUsdxIncreasesEntireTroveDebtByWithdrawnAmountPlusUpfrontFee() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 2000e18;
        uint256 interestRate = 25e16;
        uint256 usdxWithdrawal = 500e18;
        ...
        uint256 upfrontFee = predictAdjustTroveUpfrontFee(ATroveId, usdxWithdrawal);
        ...
        assertEq(entireTroveDebt_2, entireTroveDebt_1 + usdxWithdrawal + upfrontFee);
    }

    function testWithdrawUsdxIncreasesRecordedTroveDebtByAccruedInterestPlusWithdrawnAmountPlusUpfrontFee() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 2000e18;
        uint256 interestRate = 25e16;
        uint256 usdxWithdrawal = 500e18;
        ...
        uint256 recordedTroveDebt_2 = troveManager.getTroveDebt(ATroveId);
        assertEq(recordedTroveDebt_2, recordedTroveDebt_1 + accruedTroveInterest + usdxWithdrawal + upfrontFee);
    }

    // --- repayUsdx ---

    function testRepayUsdxSetsTroveLastDebtUpdateTimeToNow() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 3000e18;
        uint256 interestRate = 25e16;
        uint256 usdxRepayment = 500e18;
        ...
        // A repays usdx
        repayUsdx(A, ATroveId, usdxRepayment);

        assertEq(troveManager.getTroveLastDebtUpdateTime(ATroveId), block.timestamp);
    }

    function testRepayUsdxReducesTroveAccruedInterestTo0() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 3000e18;
        uint256 interestRate = 25e16;
        uint256 usdxRepayment = 500e18;
    ...
    function testRepayUsdxReducesEntireTroveDebtByRepaidAmount() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 3000e18;
        uint256 interestRate = 25e16;
        uint256 usdxRepayment = 500e18;
        ...
        uint256 entireTroveDebt_2 = troveManager.getTroveEntireDebt(ATroveId);
        assertEq(entireTroveDebt_2, entireTroveDebt_1 - usdxRepayment);
    }

    function testRepayUsdxChangesRecordedTroveDebtByAccruedInterestMinusRepaidAmount() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 3000e18;
        uint256 interestRate = 25e16;
        uint256 usdxRepayment = 500e18;
        ...
        assertEq(postRepay.recordedDebt, preRepay.recordedDebt + preRepay.accruedInterest - usdxRepayment);
    }
    ...
    function testApplyTroveInterestPermissionlessUpdatesRedistribution() public {
        ...
        assertGt(troveData.redistUsdxDebtGain, 0, "A should have redist gains");
    ...
    function testApplyTroveInterestPermissionlessRevertsIfTroveHasZeroDebt() public {
        ...
        // Fully redeem A
        deal(address(usdxToken), E, redeemAmount);
    ...
    function testOpenTroveMintsUpfrontFeeToInterestReceivers() public {
        ...
        assertEqDecimal(
            usdxToken.balanceOf(address(stabilityPool)) + usdxToken.balanceOf(address(mockInterestRouter)),
            fee,
            18,
