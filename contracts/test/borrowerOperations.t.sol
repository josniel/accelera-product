...
contract BorrowerOperationsTest is DevTestSetup {
    function testCloseLastTroveReverts() public {
        ...
        deal(address(usdxToken), A, aliceDebt);
    ...
    function testRepayingTooMuchDebtCapsAtMinDebt() public {
        ...
        deal(address(usdxToken), A, 3_000 ether);
        vm.prank(A);
        borrowerOperations.repayUsdx(troveId, 3_000 ether);
    ...
    function testOpenTroveChargesUpfrontFee() public {
        ...
        uint256 activePoolDebtBefore = activePool.getUsdxDebt();
        ...
        uint256 activePoolDebtAfter = activePool.getUsdxDebt();
    ...
    function testWithdrawUsdxChargesUpfrontFee() public {
        ...
        vm.prank(A);
        borrowerOperations.withdrawUsdx(troveId, withdrawal, upfrontFee);
    ...
    function testWithdrawUsdxRevertsIfUpfrontFeeExceedsUserProvidedLimit() public {
        uint256 troveId = openTroveNoHints100pct(A, 100 ether, 10_000 ether, 0.05 ether);
        ...
        vm.prank(A);
        vm.expectRevert(BorrowerOperations.UpfrontFeeTooHigh.selector);
        borrowerOperations.withdrawUsdx(troveId, withdrawal, upfrontFee - 1);
    }
    ...
    function testAdjustInterestRateChargesUpfrontFeeWhenPremature() public {
        ...
        activePoolDebtBefore = activePool.getUsdxDebt();
        ...
        activePoolDebtAfter = activePool.getUsdxDebt();
