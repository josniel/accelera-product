...
contract LiquidationsTest is DevTestSetup {
    ...
    function testLiquidationOffsetWithSurplus() public {
        ...
        initialValues.spUsdxBalance = stabilityPool.getTotalUsdxDeposits();
        ...
        // Check SP Usdx has decreased
        uint256 finalSPUsdxBalance = stabilityPool.getTotalUsdxDeposits();
        assertEq(
            initialValues.spUsdxBalance - finalSPUsdxBalance,
            liquidationAmount + initialValues.AInterest,
            "SP Usdx balance mismatch"
        );
    ...
    function testLiquidationOffsetNoSurplus() public {
        ...
        uint256 initialSPUsdxBalance = stabilityPool.getTotalUsdxDeposits();
        ...
        // Check SP Usdx has decreased
        uint256 finalSPUsdxBalance = stabilityPool.getTotalUsdxDeposits();
        assertEq(initialSPUsdxBalance - finalSPUsdxBalance, liquidationAmount + AInterest, "SP Usdx balance mismatch");
    ...
    function testLiquidationRedistributionNoSurplus() public {
        ...
        // Check empty SP
        assertEq(stabilityPool.getTotalUsdxDeposits(), 0, "SP should be empty");
    ...
    function testLiquidationMix() public {
        ...
        vars.spUsdxBalance = stabilityPool.getTotalUsdxDeposits();
        ...
        assertEq(vars.spUsdxBalance - finalSPUsdxBalance, vars.liquidationAmount / 2 - 1e18, "SP Usdx balance mismatch");
        // Check SP Coll has  increased
        uint256 finalSPCollBalance = stabilityPool.getCollBalance();
