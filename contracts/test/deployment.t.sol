...
contract Deployment is DevTestSetup {
    function testContractsDeployed() public view {
        ...
        assertNotEq(address(usdxToken), address(0));
    ...
    function testTroveManagerHasCorrectUsdxTokenAddress() public view {
        address usdxTokenAddress = address(usdxToken);
        address recordedUsdxTokenAddress = address(troveManager.usdxToken());
        assertEq(usdxTokenAddress, recordedUsdxTokenAddress);
    }
    */
    ...
    */
    ...
    function testStabilityPoolHasCorrectCorrectUsdxTokenAddress() public view {
        address usdxTokenAddress = address(usdxToken);
        address recordedUsdxTokenAddress = address(stabilityPool.usdxToken());
        assertEq(usdxTokenAddress, recordedUsdxTokenAddress);
    }
