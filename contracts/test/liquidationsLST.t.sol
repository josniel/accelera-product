...
contract LiquidationsLSTTest is DevTestSetup {
    function setUp() public override {
        ...
        (contracts, collateralRegistry, usdxToken,,,,) = deployer.deployAndConnectContracts(
    ...
    function testLiquidationFuzz(uint256 _finalPrice, uint256 _spAmount) public {
        ...
        vm.stopPrank();
        // A makes a deposit to ensure there's MIN_USDX_IN_SP left after liquidation
        makeSPDepositAndClaim(A, MIN_USDX_IN_SP);
        ...
        finalValues.spUsdxBalance = stabilityPool.getTotalUsdxDeposits();
        assertEq(initialValues.spUsdxBalance - finalValues.spUsdxBalance, _spAmount, "SP Usdx balance mismatch");
