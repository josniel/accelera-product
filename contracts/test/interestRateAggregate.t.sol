...
contract InterestRateAggregate is DevTestSetup {
    ...
    function testCalcTroveAccruedInterestReturns0When0AggRecordedDebt() public {
        ...
        // A sends Usdx to B so B can cover their interest and close their Trove
        transferUsdx(A, B, usdxToken.balanceOf(A));
    ...
    function testOpenTroveMintsInterestToSP() public {
        priceFeed.setPrice(2000e18);
        assertEq(usdxToken.balanceOf(address(stabilityPool)), 0);
        ...
        uint256 usdxBalSP_0 = usdxToken.balanceOf(address(stabilityPool));
        ...
        // Check SP Usdx bal has increased as expected from 2nd trove opening
        uint256 usdxBalSP_1 = usdxToken.balanceOf(address(stabilityPool));
        assertEq(usdxBalSP_1 - usdxBalSP_0, expectedSPYield_1);
        ...
        // Check SP Usdx bal has increased as expected from 3rd trove opening
        uint256 usdxBalSP_2 = usdxToken.balanceOf(address(stabilityPool));
        assertEq(usdxBalSP_2 - usdxBalSP_1, expectedSPYield_2);
    }
    ...
    function testSPDepositMintsInterestToSP() public {
        ...
        // Check SP Usdx bal has increased as expected from SP deposit
        uint256 usdxBalSP_2 = usdxToken.balanceOf(address(stabilityPool));
        assertEq(usdxBalSP_2, usdxBalSP_1 + sPdeposit + expectedSPYield);
    }
    ...
    function testSPWithdrawalReducesPendingAggInterestTo0() public {
        uint256 troveDebtRequest = 2000e18;
        uint256 sPdeposit = 100e18;
        // A opens Trove to obtain USDX  and makes SP deposit
        priceFeed.setPrice(2000e18);
        openTroveNoHints100pct(A, 2 ether, troveDebtRequest, 25e16);
        makeSPDepositAndClaim(A, sPdeposit);

        // B puts 1e18 in Pool so A can withdraw
        transferUsdx(A, B, 1e18);
    ...
    function testSPWithdrawalMintsInterestToSP() public {
        ...
        // Get SP balance
        uint256 usdxBalSP_1 = usdxToken.balanceOf(address(stabilityPool));
        assertGt(usdxBalSP_1, 0);

        uint256 pendingAggInterest = activePool.calcPendingAggInterest();
        assertGt(pendingAggInterest, 0);
        uint256 expectedSPYield_A = _getSPYield(pendingAggInterest);

        uint256 expectedUsdxGain_A = getShareofSPReward(A, expectedSPYield_A);
        assertGt(expectedUsdxGain_A, 0);

        // A withdraws from SP
        makeSPWithdrawalAndClaim(A, sPdeposit);

        // Check SP Usdx bal has increased as expected
        uint256 usdxBalSP_2 = usdxToken.balanceOf(address(stabilityPool));
        assertApproximatelyEqual(usdxBalSP_2, usdxBalSP_1 - sPdeposit + expectedSPYield_A - expectedUsdxGain_A, 1e3);
    }
    ...
    function testCloseTroveMintsInterestToSP() public {
        ...
        // Check SP Usdx bal has increased as expected from 3rd trove opening
        uint256 usdxBalSP_2 = usdxToken.balanceOf(address(stabilityPool));
        assertEq(usdxBalSP_2 - usdxBalSP_1, expectedSPYield);
    }
    ...
    function testCloseTroveReducesBorrowerUsdxBalByEntireTroveDebtLessGasComp() public {
        uint256 troveDebtRequest = 2000e18;
        // A, B opens Trove
        priceFeed.setPrice(2000e18);
        openTroveNoHints100pct(A, 2 ether, troveDebtRequest, 25e16);
        ...
        // A sends Usdx to B so B can cover their interest and close their Trove
        transferUsdx(A, B, usdxToken.balanceOf(A));
        uint256 bal_B = usdxToken.balanceOf(B);
        ...
        assertEq(usdxToken.balanceOf(B), bal_B - (entireDebt_B));
    }
    ...
    function testAdjustTroveInterestRateMintsAggInterestToSP() public {
        ...
        // Get SP balance
        uint256 spBal_1 = usdxToken.balanceOf(address(stabilityPool));
        ...
        // Check SP Usdx bal has increased as expected
        uint256 usdxBalSP_2 = usdxToken.balanceOf(address(stabilityPool));
        assertEq(usdxBalSP_2 - spBal_1, expectedSPYield);
    }
    ...
    function testWithdrawUsdxWithNoRedistGainsIncreasesAggRecordedDebtByPendingAggInterestPlusBorrowerDebtChange()
        public
    {
        uint256 troveDebtRequest = 2000e18;
        ...
        // A draws more debt
        withdrawUsdx100pct(A, ATroveId, debtIncrease);

        assertEq(activePool.aggRecordedDebt(), aggRecordedDebt_1 + pendingAggInterest + debtIncrease + upfrontFee);
    }

    function testWithdrawUsdxReducesPendingAggInterestTo0() public {
        uint256 troveDebtRequest = 2000e18;
        uint256 debtIncrease = 500e18;
    ...
    function testWithdrawUsdxMintsAggInterestAndUpfrontFeeToSP() public {
        uint256 troveDebtRequest = 2000e18;
        uint256 debtIncrease = 500e18;
        ...
        uint256 balanceBefore = usdxToken.balanceOf(address(stabilityPool));
        ...
        assertEq(usdxToken.balanceOf(address(stabilityPool)) - balanceBefore, expectedSPYield);
    }

    // Updates last agg update time to now
    function testWithdrawUsdxUpdatesLastAggUpdateTimeToNow() public {
        uint256 troveDebtRequest = 2000e18;
        uint256 debtIncrease = 500e18;
    ...
    function testWithdrawUsdxAdjustsWeightedDebtSumCorrectly() public {
        uint256 troveDebtRequest = 2000e18;
        uint256 debtIncrease = 500e18;
    ...
    function testRepayUsdxWithNoRedistGainsIncreasesAggRecordedDebtByPendingAggInterestMinusBorrowerDebtChange()
        public
    {
        ...
        repayUsdx(A, ATroveId, debtDecrease);

        assertEq(activePool.aggRecordedDebt(), aggRecordedDebt_1 + pendingAggInterest - debtDecrease);
    }

    function testRepayUsdxReducesPendingAggInterestTo0() public {
        uint256 troveDebtRequest = 3000e18;
        uint256 debtDecrease = 500e18;
    ...
    function testRepayUsdxMintsAggInterestToSP() public {
        uint256 troveDebtRequest = 3000e18;
        uint256 interestRate = 25e16;
        uint256 debtDecrease = 500e18;
    ...
    function testRepayUsdxUpdatesLastAggUpdateTimeToNow() public {
        uint256 troveDebtRequest = 3000e18;
        uint256 debtDecrease = 500e18;
    ...
    function testRepayUsdxAdjustsWeightedDebtSumCorrectly() public {
        uint256 troveDebtRequest = 3000e18;
        uint256 debtDecrease = 500e18;
        uint256 interestRate = 25e16;
    ...
    function testApplyTroveInterestPermissionlessMintsPendingAggInterestToSP() public {
        ...
        // Check SP Usdx bal has increased by the pending agg interest
        assertEq(usdxToken.balanceOf(address(stabilityPool)) - balanceBefore, expectedSPYield);
    }
    ...
    function testBatchLiquidateTrovesPureOffsetMintsAggInterestToSP() public {
        ...
        // Check SP Usdx bal has increased as expected from liquidation: depleted by Trove debts C and D, increased by pending
        // interest
        uint256 usdxBalSP_2 = usdxToken.balanceOf(address(stabilityPool));
        assertEq(usdxBalSP_2, usdxBalSP_1 - debt_C - debt_D + expectedSPYield);
    }
    ...
    function testBatchLiquidateTrovesPureRedistMintsAggInterestToSP() public {
        ...
        // Check SP Usdx bal has increased as expected from liquidation
        uint256 usdxBalSP_2 = usdxToken.balanceOf(address(stabilityPool));
        assertEq(usdxBalSP_2 - usdxBalSP_1, expectedSPYield);
    }
        ...
        public
    {
        ...
        uint256 defaultPoolDebt = defaultPool.getUsdxDebt();
        ...
        assertEq(defaultPool.getUsdxDebt(), debtInLiq);
    }
    ...
    function testClaimAllCollGainsMintsAggInterestToSP() public {
        ...
        assertGt(pendingAggInterest, 0);
        uint256 expectedSPYield = _getSPYield(pendingAggInterest);
        uint256 expectedUsdxGain_A = getShareofSPReward(A, expectedSPYield);
        ...
        // Check SP Usdx bal has changed as expected - by the pendingAggInterest, minus A's share of it which gets paid out
        uint256 usdxBalSP_2 = usdxToken.balanceOf(address(stabilityPool));
        assertApproximatelyEqual(usdxBalSP_2, usdxBalSP_1 + expectedSPYield - expectedUsdxGain_A, 1e3);
    }
