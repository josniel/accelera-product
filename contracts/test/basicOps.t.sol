...
contract BasicOps is DevTestSetup {
    ...
    function testCloseTrove() public {
        ...
        // Transfer some Usdx to B so that B can close Trove accounting for interest and upfront fee
        usdxToken.transfer(B, 100e18);
        vm.stopPrank();
    ...
    function testRedeem() public {
        ...
        uint256 redemptionAmount = 1000e18; // 1k USDX
    ...
    function testSPDeposit() public {
        ...
        assertGt(usdxToken.balanceOf(A), 1800e18, "Wrong usdx balance");
        assertLt(usdxToken.balanceOf(A), 1801e18, "Wrong usdx balance");
        assertApproximatelyEqual(stabilityPool.getCompoundedUsdxDeposit(A), 200e18, 1e3, "Wrong SP deposit");
    }
    ...
    function testSPWithdrawal() public {
        ...
        assertEq(usdxToken.balanceOf(A), 1900e18);
        assertApproximatelyEqual(stabilityPool.getCompoundedUsdxDeposit(A), 100e18, 1e2);
        ...
        assertGt(usdxToken.balanceOf(A), 1999e18, "Wrong usdx balance");
        assertLt(usdxToken.balanceOf(A), 2000e18, "Wrong usdx balance");
        assertEq(stabilityPool.getCompoundedUsdxDeposit(A), 1e18, "Wrong SP deposit");
    }
}
