...
methods {
    ...
    function _.getTotalUsdxDeposits() external => DISPATCHER(true);
...
// -Redemption from Trove i and from batch Trove j of the same USDX amount
// STATUS: VERIFIED
...
rule trove_batch_trove_eq_redeem {
    ...
    uint256 usdxX = troveManager.redeemCollateralFromTroveHarnessed(e,
        defaultPool,
        singleRedemptionX,
        maxUsdxAmount,
        price,
    ...
    uint256 usdxY = troveManager.redeemCollateralFromTroveHarnessed(e,
        defaultPool,
        singleRedemptionY,
        maxUsdxAmount,
        price,
    ...
    // ensure the same amount of usdx is redeemed in both cases
    require usdxX == usdxY;
