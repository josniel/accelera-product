...
contract GasCompZapper is BaseZapper {
    ...
    function _adjustTrovePre(
        ...
        address receiver =
            _checkAdjustTroveManagers(_troveId, _collChange, _isCollIncrease, _usdxChange, _isDebtIncrease);

        // Set initial balances to make sure there are not lefovers
        _setInitialTokensAndBalances(collToken, usdxToken, _initialBalances);
    ...
    function receiveFlashLoanOnCloseTroveFromCollateral(
        ...
        //require(receivedUsdxAmount >= trove.entireDebt, "GCZ: Not enough USDX obtained to repay");
